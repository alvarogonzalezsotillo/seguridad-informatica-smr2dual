...
\begin{homeworkProblem}[: Escalada de privilegios en \textbf{Linux} (2 puntos)]
  ...
  \begin{multicols}{2}
    ...
    \begin{ActividadHacker}[2. El \textit{hacker} lo aprovecha]
      ...
      \item Crea una copia de la \textit{shell} (\texttt{/usr/bash}) en el directorio \textit{home} de \textbf{normal} (\path{/home/normal/shell-de-root})
...
\begin{homeworkProblem}[: Implementa el uso de cuotas de disco en \textbf{Linux} (3 puntos)]
  ...
  \begin{multicols}{2}
    ...
    \begin{ActividadAdmin}[2. El administrador lo soluciona]
      ...
      \item \justify Haz que el usuario \texttt{normal} tenga una cuota de 1000 KBytes, Observa qué ocurre cuando intenta utilizar más de este espacio del disco.
      \end{itemize}
